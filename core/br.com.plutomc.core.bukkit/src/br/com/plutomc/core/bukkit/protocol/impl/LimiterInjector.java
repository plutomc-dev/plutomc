...
public class LimiterInjector implements PacketInjector {
   ...
   public void inject(Plugin plugin) {
      ProtocolLibrary.getProtocolManager()
         .addPacketListener(
            new PacketAdapter(BukkitMain.getInstance(), ListenerPriority.LOWEST, Client.WINDOW_CLICK, Client.CUSTOM_PAYLOAD) {
      ...
      ProtocolLibrary.getProtocolManager()
         .addPacketListener(new PacketAdapter(BukkitMain.getInstance(), ListenerPriority.LOWEST, Server.CHAT, Client.CHAT, Client.WINDOW_CLICK) {
