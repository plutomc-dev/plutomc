               ...
               menuInventory.setItem(
                  ...
                  new ItemBuilder()
                     ...
                     .lore(
                        ...
                        "§fKillstream máximo: §7" + status.getInteger("killstreak-max", 0)
                     )
                     .build()
               );
               menuInventory.setItem(
                  ...
                  new ItemBuilder()
                     ...
                     .name("§aArena")
                     .lore("§fKills: §70", "§fDeaths: §70", "§fKillstreak: §70", "§fKillstream máximo: §70", "")
                     .build()
               );
               menuInventory.setItem(
                  12,
                  new ItemBuilder()
                     ...
                     .lore(
                        ...
                        "§fKillstream máximo: §7" + status.getInteger("fps-killstreak-max", 0)
                     )
                     .build()
               );
