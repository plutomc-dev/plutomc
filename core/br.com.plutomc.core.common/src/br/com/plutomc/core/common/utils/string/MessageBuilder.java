...
public class MessageBuilder {
   ...
   public MessageBuilder setClickEvent(net.md_5.bungee.api.chat.ClickEvent.Action action, String text) {
   ...
   public MessageBuilder setClickEvent(String text) {
      this.clickEvent = new ClickEvent(net.md_5.bungee.api.chat.ClickEvent.Action.RUN_COMMAND, text);
      this.clickable = true;
      return this;
   }
